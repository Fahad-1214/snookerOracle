    ...
    return (
        <footer className=" flex justify-center items-center py-10 lg:px-10 gap-10 h-[200px]">
            ...
            <div className="text-center mx-auto text-xs max-w-[700px]">
                ...
                Links to other sites are provided for your convenience, but Snooker Orakel accepts no responsibility or liability for the content of those sites or of any external sites which link to this site.llo
            </div>
            <div>
